...
function my_keydown(e)
{
	...
	function up()
	{
		if(ball_y >=0)
		{
			...
			console.log("Quando a seta para cima é pressionada, X = " + ball_x + " , Y = 0"+ball_y);
			canvas.remove(ball_obj);
			new_image();	
		}
	}
	...
	function down()
	{
		if(ball_y <=450)
		{
			ball_y = ball_y + block_image_height;
			console.log("altura do bloco da imagem = " + block_image_height);
			console.log("Quando a seta para baixo é pressionada, X = " + ball_x + " , Y = 0"+ball_y);
			canvas.remove(ball_obj);
			new_image();			
		}
	...
	function left()
	{
		if(ball_x >5)
		{
			...
			console.log("Quando a seta para esquerda é pressionada, X = " + ball_x + " , Y = 0"+ball_y);
			canvas.remove(ball_obj);
			new_image();	
		}
	}
	...
	function right()
	{
		if(ball_x <=1050)
		{
			ball_x = ball_x + block_image_width;
			console.log("altura do bloco da imagem = " + block_image_height);
			console.log("Quando a seta para direita é pressionada, X = " + ball_x + " , Y = 0"+ball_y);
			canvas.remove(ball_obj);
			new_image();
		}
	}
